...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Gem that install all system dependencies for your rails project.}
  spec.description   = %q{Collects the project dependencies and operating system information, sends them to
